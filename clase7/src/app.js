...
//1) Codigos de estado. (http.cat / http.dog)
//2) ¿Que es una API? 
//3) API Rest
...
//"type": "module" en package.json para poder importar/exportar módulos de JavaScript ES6 en lugar de CommonJS
...
app.get("/conlimite/:limit", (req, res) => {
    ...
    //la información que llega por params o query, siempre llega en string, por lo que es necesario parsearla
